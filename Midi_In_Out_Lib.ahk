; Last edited 12/20/2018 8:46 PM by genmce
;*************************************************
...
/* 
  ...
  - Write .ini to save port selections
  - Parse Midi message input data 
  - Midi input and output monitor gui
*/

/*  -------------- old text ----------------------------------------
    This part is meant to take care of the midi configuration; midi input and output selection and save selection to an ini file.
    ...
    * use it as an include.
    ...
    Unicode port listing works
    NOT SURE WHO IS RESPONSIBLE FOR THE UNICODE PORT HANDLING - Grass_HOPEr or lmstearn  or Zelio from 
    https://autohotkey.com/boards/viewtopic.php?t=222
    
    ; Last edited 12/13/2018 11:30 AM by genmce
    I will endeavor to clean this up, while still keep it working
*/
...
;   unicode fix by Grass_HOPEr (I think)
;*************************************************
